...
// Codepage037 implements the IBM CP 037 code page.
//
// IBM CP 037 <-> Unicode mappings from https://github.com/unicode-org/icu-data
// file: ibm-37_P100-1999.ucm
var Codepage037 *codepage = &codepage{
	id: "037",
	e2u: []rune{
