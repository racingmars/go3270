...
// Codepage924 implements the IBM CP 924 code page.
//
// IBM CP 924 <-> Unicode mappings from https://github.com/unicode-org/icu-data
// file: ibm-924_P100-1998.ucm
var Codepage924 *codepage = &codepage{
	id: "924",
	e2u: []rune{
	...
	highu2e: map[rune]byte{
		0x0153: 0xB8, 0x0178: 0xB9, 0x017D: 0xBE, 0x017E: 0x9D,
		0x0152: 0xB7, 0x0161: 0xBB, 0x0160: 0x6A, 0x20AC: 0x9F,
	},
	esub: 0x3f,
	ge:   0x08,
	ge2u: cp310ToUnicode,
